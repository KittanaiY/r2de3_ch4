...
if __name__ =='__main__':
    ...
    if command.strip().lowwer() == "upload" or command.strip.lowwer() == 'u':
        upload_blob(bucket_name,file_name,saved_name)
        # upload_blob("r2de3-workshop-gritta", "../README-cloudshell.txt", "hello_cloudshell")
    if command.strip().lowwer() == "download" or command.strip.lowwer() == 'd':
        download_byte_range(bucket_name, file_name,saved_name)
    else:
